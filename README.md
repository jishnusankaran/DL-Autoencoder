...
def train(model, loader, criterion, optimizer, epochs=5):
    model.train()
    print("Name : JISHNUPRIYAN S")
    print("Register Number : 212223240061")
...
def visualize_denoising(model, loader, num_images=10):
    ...
    print("Name: JISHNUPRIYAN S")
    print("Register Number: 21222240061 ")
...
### Training loss
<img width="1911" height="823" alt="jkh" src="https://github.com/user-attachments/assets/713b4cdd-ae66-4609-bb05-2624c5044cbd" />




## Original vs Noisy Vs Reconstructed Image
<img width="1994" height="789" alt="6a6864fe-af21-4230-aebc-19fd30b2e15e" src="https://github.com/user-attachments/assets/7a41b9cc-a818-4c0a-8470-5f8bcf581b5b" />
